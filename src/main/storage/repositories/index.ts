...
import { ReadingListRepository } from './reading-list.repo';
...
export class Repositories {
  ...
  constructor(db: Db) {
    ...
    this.readingList = new ReadingListRepository(raw);
    this.notes = new NotesRepository(raw);
...
export { ReadingListRepository } from './reading-list.repo';
